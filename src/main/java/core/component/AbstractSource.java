...
public abstract class AbstractSource extends BaseComponent implements MediaSource {
  ...
  //duration of media stream in nanoseconds
     ...
     * (Non Java-doc).
     * 
     * @see org.mobicents.MediaSource#getMediaTime();
     */
     ...
     * (Non Java-doc).
     * 
     * @see org.mobicents.MediaSource#setDuration(long duration);
     */
     ...
     * (Non Java-doc).
     * 
     * @see org.mobicents.MediaSource#getDuration();
     */
     ...
     * (Non Java-doc).
     * 
     * @see org.mobicents.MediaSource#setMediaTime(long timestamp);
     */
     ...
     * (Non Java-doc).
     * 
     * @see org.mobicents.MediaSource#start().
     */
    public void start() {
    	synchronized(worker) {
    		//check scheduler
     ...
     * (Non Java-doc).
     * 
     * @see org.mobicents.MediaSource#stop().
     */
    public void stop() {
        if (started) {
            stopped();
     ...
     * (Non Java-doc).
     *
     * @see MediaSource#connect(MediaSink)
     * @param sink
     */
     ...
     * (Non Java-doc).
     *
     * @see MediaSource#disconnect(org.mobicents.server.spi.io.Pipe)
     */
     ...
     * (Non Java-doc).
     * 
     * @see org.mobicents.MediaSink#isConnected().
     */
     ...
     * (Non Java-doc).
     * 
     * @see org.mobicents.MediaSource#isStarted().
     */
     ...
     * attributes.
     * 
     * @param buffer the buffer object for 
     ...
     * (Non Java-doc).
     * 
     * @see MediaSource#getPacketsReceived()
     */
    ...
    private class Worker extends Task {
         ...
         * (Non Java-doc.)
         *
         * @see core.scheduler.Task#perform()
         */
        public long perform() {
